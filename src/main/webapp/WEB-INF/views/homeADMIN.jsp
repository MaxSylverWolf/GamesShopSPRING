...
<a href="gameList.html">Lista gier</a><br/>
<a href="registerList.html">Lista użytkowników</a><br/>
<a href="gameForm.html">Dodaj grę</a><br/>
<a href="orderList.html">Sprawdź zamówienia</a><br/>
<a href="logout.html">Wyloguj</a>
</c:when>
<c:otherwise>
<span style="color:red">Panel Admina, zaloguj się.</span>

<a href="logonADMINForm.html">Zaloguj</a>
</c:otherwise>
</c:choose>
